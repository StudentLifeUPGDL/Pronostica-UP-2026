      ...
      <div>
          ...
          {'ABCDEFGHIJKL'.split('').map(g => {
            ...
            return (
              <button key={g} onClick={() => setActiveGroup(g)}
                ...
                style={{
                  fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", fontSize: '0.9rem', fontWeight: 700,
        ...
        <div className="rounded-xl overflow-hidden mb-4" style={{ background: '#083524', border: '1px solid rgba(245,166,35,0.15)' }}>
          <div className="px-4 py-2.5 flex items-center justify-between"
            ...
            <span style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#f5a623', fontSize: '1rem', letterSpacing: '0.06em' }}>
              GRUPO {activeGroup}
            </span>
            <span style={{ color: '#4a7d65', fontSize: '0.68rem', fontFamily: "'Twemoji Country Flags', 'DM Mono'" }}>Toca para asignar posición</span>
          </div>
              ...
              return (
                <button key={team.id} onClick={() => pickGroupTeam(activeGroup, team.id)}
                  ...
                  <div className="flex-1">
                    <div style={{ fontSize: '0.9rem', color: '#e0f0e8', fontFamily: "'Twemoji Country Flags', 'Nunito Sans', sans-serif", fontWeight: 600 }}>{team.name}</div>
                    <div style={{ fontSize: '0.68rem', color: '#3a6b55', fontFamily: "'Twemoji Country Flags', 'DM Mono'" }}>{team.confederation}</div>
                  </div>
                  {pos && (
                    <div className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0"
                      style={{ background: `${pc}18`, border: `1.5px solid ${pc}40` }}>
                      <span style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", fontSize: '0.9rem', color: pc, fontWeight: 700 }}>{pos}</span>
                    </div>
                  )}
                </button>
              );
          ...
          {GROUPS.map(g => {
            ...
            return (
              <button key={g.id} onClick={() => setActiveGroup(g.id)}
                ...
                <div style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#f5a623', fontSize: '0.68rem', letterSpacing: '0.1em', marginBottom: '4px' }}>
                  GR. {g.id}
                </div>
                {(['first','second','third'] as const).map((pos, pi) => {
                  ...
                  return (
                    <div key={pos} className="flex items-center gap-1">
                      <span style={{ fontFamily: "'Twemoji Country Flags', 'DM Mono'", fontSize: '0.56rem', color: pc, minWidth: '14px' }}>{pi+1}°</span>
                      {t ? (<><span style={{ fontSize: '0.78rem' }}>{t.flag}</span><span style={{ fontSize: '0.65rem', color: '#a0c4b0', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'" }}>{t.shortName}</span></>)
      ...
      <div>
        <div className="rounded-xl p-4 mb-4" style={{ background: 'rgba(230,57,70,0.07)', border: '1px solid rgba(230,57,70,0.2)' }}>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#e63946', fontSize: '0.88rem', letterSpacing: '0.05em' }}>
              SELECCIONA 4 TERCEROS QUE NO AVANZAN
            </span>
          </div>
          <p style={{ color: '#9cc4b2', fontSize: '0.8rem', fontFamily: "'Twemoji Country Flags', 'Nunito Sans', sans-serif" }}>
        ...
        <div className="flex gap-3 mb-4">
          <div className="flex-1 rounded-xl p-3 text-center" style={{ background: 'rgba(74,222,128,0.06)', border: '1px solid rgba(74,222,128,0.15)' }}>
            <div style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", fontSize: '1.6rem', color: '#4ade80', fontWeight: 700, lineHeight: 1 }}>
              {advancing.length}<span style={{ fontSize: '0.8rem', color: '#1a5a3a' }}>/8</span>
            </div>
            <div style={{ fontSize: '0.66rem', color: '#7eb89a', fontFamily: "'Twemoji Country Flags', 'DM Mono'", letterSpacing: '0.06em', marginTop: '2px' }}>AVANZAN</div>
          </div>
          <div className="flex-1 rounded-xl p-3 text-center" style={{ background: 'rgba(230,57,70,0.06)', border: `1px solid ${done ? 'rgba(230,57,70,0.4)' : 'rgba(230,57,70,0.15)'}` }}>
            <div style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", fontSize: '1.6rem', color: '#e63946', fontWeight: 700, lineHeight: 1 }}>
              {elim3rd.length}<span style={{ fontSize: '0.8rem', color: '#5a1a1a' }}>/4</span>
            </div>
            <div style={{ fontSize: '0.66rem', color: '#e63946', fontFamily: "'Twemoji Country Flags', 'DM Mono'", letterSpacing: '0.06em', marginTop: '2px' }}>ELIMINADOS</div>
          </div>
        </div>
        ...
        {allThirds.length < 12 && (
          <div className="rounded-xl p-3 mb-4 flex items-center gap-2" style={{ background: 'rgba(245,166,35,0.07)', border: '1px solid rgba(245,166,35,0.15)' }}>
            ...
            <span style={{ color: '#f5a623', fontSize: '0.8rem', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'" }}>
            ...
            return (
              <button key={g.id}
                ...
                <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
                  ...
                  <span style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", fontSize: '0.8rem', fontWeight: 700,
                  ...
                  {team ? (
                    <>
                      <div className="flex items-center gap-1.5">
                        ...
                        <span style={{ fontSize: '0.85rem', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'", fontWeight: 600,
                          color: isElim ? '#e63946' : '#e0f0e8' }}>{team.name}</span>
                      </div>
                      <div style={{ fontSize: '0.63rem', color: isElim ? '#a03040' : '#3a6b55', fontFamily: "'Twemoji Country Flags', 'DM Mono'" }}>
                        3° Grupo {g.id}
                      </div>
                    </>
                  ) : (
                    <span style={{ color: '#2a5040', fontSize: '0.78rem', fontStyle: 'italic', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'" }}>Sin asignar (completa el grupo {g.id})</span>
                  )}
                </div>
                <span className="flex-shrink-0 px-2 py-0.5 rounded-full text-xs"
                  style={{ background: isElim ? 'rgba(230,57,70,0.15)' : teamId ? 'rgba(74,222,128,0.1)' : 'transparent',
                    color: isElim ? '#e63946' : '#4ade80', fontFamily: "'Twemoji Country Flags', 'DM Mono'", fontSize: '0.6rem' }}>
        ...
        {advancing.length > 0 && (
          <div className="mt-4 rounded-xl p-4" style={{ background: '#083524', border: '1px solid rgba(255,255,255,0.05)' }}>
            <div style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#7eb89a', fontSize: '0.72rem', letterSpacing: '0.08em', marginBottom: '8px' }}>
              ...
              {advancing.map(t => {
                ...
                return (
                  <div key={t.teamId} className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg"
                    ...
                    <span>{team.flag}</span>
                    <span style={{ fontSize: '0.75rem', color: '#4ade80', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'", fontWeight: 600 }}>{team.shortName}</span>
                    <span style={{ fontSize: '0.58rem', color: '#2a5a3a', fontFamily: "'Twemoji Country Flags', 'DM Mono'" }}>3°{t.group}</span>
                  </div>
                );
              })}
            </div>
          ...
          {Object.entries(byDate).map(([date, matches]) => (
            <div key={date}>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#f5a623', fontSize: '0.82rem', letterSpacing: '0.08em' }}>
                  {date.toUpperCase()}
                </span>
                  ...
                  return (
                    <div key={m.id} className="rounded-xl overflow-hidden flex flex-col"
                      ...
                      <div className="px-3 py-1.5 flex items-center justify-between gap-2"
                        ...
                        <span style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#f5a623', fontSize: '0.72rem', letterSpacing: '0.1em' }}>
                          P{m.matchNum}
                        </span>
                        <div className="flex items-center gap-2">
                          <span style={{ display: 'flex', alignItems: 'center', gap: '2px', color: '#4a7d65', fontSize: '0.6rem', fontFamily: "'Twemoji Country Flags', 'DM Mono'" }}>
                      ...
                      <div className="p-2.5 flex flex-col gap-2 flex-1">
                        ...
                        <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg"
                          ...
                          {homeId ? (
                            <>
                              ...
                              <span style={{ fontSize: '0.82rem', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'", fontWeight: 600, color: '#c0d8cc' }}>
                                {getTeam(homeId).name}
                              </span>
                            </>
                          ) : (
                            <span style={{ fontSize: '0.75rem', color: '#3a6b55', fontFamily: "'Twemoji Country Flags', 'DM Mono'", fontStyle: 'italic' }}>
                              {m.home.type === 'pos' ? `1° Gr.${m.home.group}` : '?'} — pendiente
                            </span>
                          )}
                          <span style={{ marginLeft: 'auto', fontSize: '0.58rem', color: '#3a6b55', fontFamily: "'Twemoji Country Flags', 'DM Mono'" }}>
                            {m.home.type === 'pos' ? `${m.home.pos}°${m.home.group}` : ''}
                          </span>
                        </div>

                        <div className="text-center" style={{ color: '#2a5a3a', fontSize: '0.62rem', fontFamily: "'Twemoji Country Flags', 'DM Mono'", letterSpacing: '0.1em' }}>
                          VS
                        </div>
                        ...
                        <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg"
                          ...
                          {awayId ? (
                            <>
                              ...
                              <span style={{ marginLeft: 'auto', fontSize: '0.58rem', color: m.away.type === 'best3rd' ? '#c084fc' : '#3a6b55', fontFamily: "'Twemoji Country Flags', 'DM Mono'" }}>
                        ...
                        {homeId && awayId && (
                          <>
                            ...
                            <div style={{ fontSize: '0.62rem', color: '#4a7d65', fontFamily: "'Twemoji Country Flags', 'DM Mono'", letterSpacing: '0.06em' }}>
                              GANADOR:
                            </div>
                              ...
                              {[homeId, awayId].map(tid => {
                                ...
                                return (
                                  <button key={tid} onClick={() => pickR32(m.id, tid)}
                                    ...
                                    <span style={{ fontSize: '0.72rem', color: sel ? '#f5a623' : '#9cc4b2', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'", fontWeight: 600 }}>
                                      {t.shortName}
                                    </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="p-2.5 flex flex-col gap-1.5">
                {both ? (
                    ...
                    {[homeId, awayId].map(tid => {
                      ...
                      return (
                        <button key={tid} onClick={() => { setPicks(p => ({ ...p, [pair.id]: tid! })); setNavError(''); }}
                          ...
                          <span style={{ flex: 1, fontSize: '0.82rem', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'", fontWeight: 600,
                  ...
                  <div className="py-3 text-center" style={{ color: '#3a6b55', fontSize: '0.78rem', fontStyle: 'italic', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'" }}>
    ...
    return (
      <div>
        <div className="rounded-xl p-4 mb-4 text-center" style={{ background: 'rgba(245,166,35,0.07)', border: '1px solid rgba(245,166,35,0.2)' }}>
          ...
          <div style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#f5a623', fontSize: '1.1rem', letterSpacing: '0.08em' }}>GRAN FINAL · P{FINAL_INFO.matchNum}</div>
          <p style={{ color: '#4a7d65', fontSize: '0.7rem', fontFamily: "'Twemoji Country Flags', 'DM Mono'", marginTop: '2px' }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          <div>
            <div style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#f5a623', fontSize: '0.78rem', letterSpacing: '0.08em', marginBottom: '8px' }}>🏆 FINAL — CAMPEÓN</div>
              ...
              {[f1, f2].filter(Boolean).map(tid => {
                ...
                return (
                  <button key={tid} onClick={() => { setChampion(tid!); setRunnerUp(tid === f1 ? (f2 ?? '') : (f1 ?? '')); setNavError(''); }}
                    ...
                    <span className="text-xl">{t.flag}</span>
                    <span style={{ flex: 1, fontSize: '0.82rem', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'", fontWeight: 600, color: sel ? '#f5a623' : '#c0d8cc' }}>{t.name}</span>
                    {sel && <><Check size={13} style={{ color: '#f5a623' }} /><span style={{ fontSize: '0.65rem', color: '#f5a623', fontFamily: "'Twemoji Country Flags', 'DM Mono'" }}>CAMPEÓN</span></>}
                  </button>
                );
              })}
              {!f1 && !f2 && <div style={{ color: '#3a6b55', fontSize: '0.78rem', fontStyle: 'italic', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'", textAlign: 'center', padding: '12px' }}>Completa las semis primero</div>}
            </div>
          </div>
          <div>
            <div style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#9cc4b2', fontSize: '0.78rem', letterSpacing: '0.08em', marginBottom: '2px' }}>🥉 3ER Y 4TO LUGAR · P{BRONZE_INFO.matchNum}</div>
            <div style={{ color: '#4a7d65', fontSize: '0.62rem', fontFamily: "'Twemoji Country Flags', 'DM Mono'", marginBottom: '8px' }}>{BRONZE_INFO.date} 2026 · {BRONZE_INFO.time} h · {BRONZE_INFO.stadium}</div>
            <div className="grid grid-cols-1 gap-1.5">
              {[sf1Loser, sf2Loser].filter(Boolean).map(tid => {
                ...
                return (
                  <button key={tid} onClick={() => { setThirdPlace(tid!); setNavError(''); }}
                    ...
                    <span className="text-xl">{t.flag}</span>
                    <span style={{ flex: 1, fontSize: '0.82rem', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'", fontWeight: 600, color: sel ? '#9cc4b2' : '#c0d8cc' }}>{t.name}</span>
                    {sel && <><Check size={13} style={{ color: '#9cc4b2' }} /><span style={{ fontSize: '0.65rem', color: '#9cc4b2', fontFamily: "'Twemoji Country Flags', 'DM Mono'" }}>3° LUG.</span></>}
                  </button>
                );
              })}
              {(!sf1Loser || !sf2Loser) && <div style={{ color: '#3a6b55', fontSize: '0.78rem', fontStyle: 'italic', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'", textAlign: 'center', padding: '12px' }}>Completa las semis primero</div>}
            </div>
          </div>
        </div>
        ...
        {champion && (
          <div className="rounded-xl p-4" style={{ background: 'rgba(245,166,35,0.06)', border: '1px solid rgba(245,166,35,0.2)' }}>
            <div style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#f5a623', fontSize: '0.78rem', letterSpacing: '0.08em', marginBottom: '8px' }}>RESUMEN</div>
            {[{ label: '🏆 Campeón', id: champion }, { label: '🥈 Subcampeón', id: runnerUp }, { label: '🥉 3er Lugar', id: thirdPlace }].map(({ label, id }) => {
              ...
              return (
                <div key={label} className="flex items-center gap-2 mb-1.5">
                  <span style={{ color: '#7eb89a', fontSize: '0.78rem', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'", minWidth: '110px' }}>{label}</span>
                  {t ? <><span>{t.flag}</span><span style={{ fontSize: '0.88rem', color: '#e0f0e8', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'", fontWeight: 600 }}>{t.name}</span></>
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-10">
        <div className="rounded-2xl p-8 text-center" style={{ background: '#0d5035', border: '1px solid rgba(74,222,128,0.25)' }}>
          ...
          <h1 style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#4ade80', fontSize: '1.5rem', fontWeight: 700, letterSpacing: '0.04em' }}>
          ...
          <div className="mt-6 rounded-xl p-5" style={{ background: '#083524', border: '1px solid rgba(245,166,35,0.25)' }}>
            <div style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#7eb89a', fontSize: '0.7rem', letterSpacing: '0.12em', marginBottom: '10px' }}>TU FOLIO</div>
            <button onClick={copyFolio} title="Copiar folio"
              ...
              style={{ background: 'rgba(245,166,35,0.1)', border: '1px solid rgba(245,166,35,0.3)', padding: '10px 18px', fontFamily: "'Twemoji Country Flags', 'DM Mono'", color: '#f5a623', fontSize: '1.4rem', letterSpacing: '0.06em' }}>
              {saved.pred.id}
              {copied ? <Check size={18} style={{ color: '#4ade80' }} /> : <Copy size={18} style={{ color: '#9cc4b2' }} />}
            </button>
            <div style={{ color: copied ? '#4ade80' : '#4a7d65', fontSize: '0.72rem', fontFamily: "'Twemoji Country Flags', 'DM Mono'", marginTop: '10px' }}>
          ...
          <button onClick={onCancel}
            ...
            style={{ background: '#f5a623', color: '#062b1a', fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", fontWeight: 700, fontSize: '0.86rem', letterSpacing: '0.05em' }}>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          <h1 style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#f5a623', fontSize: '1.5rem', fontWeight: 700, letterSpacing: '0.04em' }}>{name}</h1>
          <p style={{ color: mode === 'main' ? '#4a7d65' : '#c084fc', fontSize: '0.7rem', fontFamily: "'Twemoji Country Flags', 'DM Mono'" }}>
            {mode === 'main'
              ? (userDisplayName ?? '')
              : `LIGA APARTE · ${entryRound === 'r32' ? 'DIECISEISAVOS (R32)' : 'OCTAVOS (R16)'}`}
          </p>
        </div>
        <button onClick={onCancel} style={{ color: '#7eb89a', fontSize: '0.76rem', fontFamily: "'Twemoji Country Flags', 'DM Mono'", cursor: 'pointer' }}>← Volver</button>
      </div>
            ...
            <div key={s} className="flex items-center gap-0.5 flex-shrink-0">
              <button
                ...
                style={{
                  ...
                  fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", fontSize: '0.64rem', letterSpacing: '0.07em',
      ...
      <div className="rounded-xl p-5 mb-4" style={{ background: '#083524', border: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="flex items-center gap-2 mb-4">
          ...
          <span style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#f5a623', fontSize: '0.95rem', letterSpacing: '0.06em' }}>
            {STEP_LABELS[step]}
          </span>
          {/* Completion badge */}
          <span className="ml-auto px-2 py-0.5 rounded-full"
            style={{
              ...
              fontSize: '0.62rem', fontFamily: "'Twemoji Country Flags', 'DM Mono'",
            }}>
        ...
        {isLocked(step) ? (
          <div className="rounded-xl p-5 text-center" style={{ background: 'rgba(192,132,252,0.06)', border: '1px solid rgba(192,132,252,0.2)' }}>
            ...
            <div style={{ fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", color: '#c084fc', fontSize: '0.9rem', letterSpacing: '0.05em' }}>
              FASE DEFINIDA
            </div>
            <p style={{ color: '#9cc4b2', fontSize: '0.82rem', marginTop: '6px', fontFamily: "'Twemoji Country Flags', 'Nunito Sans'" }}>
      ...
      {navError && (
        <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl mb-3"
          ...
          <span style={{ color: '#e63946', fontSize: '0.8rem', fontFamily: "'Twemoji Country Flags', 'Nunito Sans', sans-serif" }}>
            {navError}
          </span>
        </div>
      )}
      ...
      <div className="flex items-center justify-between gap-3">
        <button onClick={handlePrev} disabled={stepIdx === 0 || saving}
          ...
          style={{ background: '#0d5035', color: '#7eb89a', fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", fontSize: '0.82rem', letterSpacing: '0.05em', border: '1px solid rgba(255,255,255,0.07)' }}>
          <ChevronLeft size={15} /> ANTERIOR
        </button>

        <button onClick={handleSave} disabled={saving}
          className="flex items-center gap-1.5 px-4 py-2.5 rounded-lg cursor-pointer disabled:opacity-50"
          style={{ background: 'rgba(74,222,128,0.12)', color: '#4ade80', fontFamily: "'Twemoji Country Flags', 'Oswald', sans-serif", fontSize: '0.82rem', letterSpacing: '0.05em', border: '1px solid rgba(74,222,128,0.22)' }}>
